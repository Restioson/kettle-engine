...
import io.github.restioson.kettle.BaseClientSide
import io.github.restioson.kettle.api.Kettle
import io.github.restioson.kettle.api.Level

class TestClientSide(engine: Kettle, level: Level, width: Float, height: Float) : BaseClientSide(engine, level, width, height) {
